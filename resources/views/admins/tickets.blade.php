                  ...
                  <div class="list-icons">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('admin.ticketDetail', ['id' => $data->id] ); }}" class="dropdown-item"><i class="icon-pencil5"></i> 編集</a>
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('admin.ticketDelete', ['id' => $data->id] ); }}" onclick="return confirm('削除しますか？');" class="dropdown-item text-danger">
