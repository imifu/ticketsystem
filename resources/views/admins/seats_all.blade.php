                ...
                <div class="table-responsive">
                    <table class="table text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="text-default font-weight-semibold">{{ $data->ticket_detail_id }}</span>
                                </td>
                                ...
                                <td><span class="text-default font-weight-semibold">{{ $data->ticket_amount }} 枚</span></td>
                                <td><span class="text-default font-weight-semibold">{{ number_format($data->amount) }} 円</span></td>
                                <td><span class="text-default font-weight-semibold">{{ number_format($data->commission) }} 円</span></td>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('admin.seatDetail', ['ticket_id' => $data->ticket_id,'id' => $data->ticket_detail_id] ); }}" class="dropdown-item"><i class="icon-pencil5"></i> 編集</a>
