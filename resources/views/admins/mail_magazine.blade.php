				...
				<div class="card-body">
					...
					<form action="{{ route('admin.ticketSave') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                            <textarea name="ticket_explain" id="ticket_explain" class="form-control" cols="30" rows="30" placeholder="本文をご入力ください">{{ old('ticket_explain') ? old('ticket_explain') : null }}{{ !empty($data['ticket_explain']) ? $data['ticket_explain'] : null }}</textarea>
                            </div>
                        </div>
