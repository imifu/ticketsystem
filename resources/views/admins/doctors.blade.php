			...
			<div class="page-header">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">ドクター一覧</span></h4>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<img src="{{url('/')}}/img/doctor/{{ $data->main_image }}" style="max-width:50px;"/>
											</td>
												...
												<div class="list-icons">
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a href="{{url('/')}}/{{config('const.ADMIN_URL')}}/doctor/{{ $data->id }}" class="dropdown-item"><i class="icon-pencil5"></i> 編集</a>
															<div class="dropdown-divider"></div>
															<a href="{{url('/')}}/{{config('const.ADMIN_URL')}}/doctorDelete/{{ $data->id }}" onclick="return confirm('削除しますか？');" class="dropdown-item text-danger"><i class="icon-trash"></i> 削除</a>
														</div>
													</div>
												</div>
											</td>
