                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.seatSave') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <fieldset class="mb-3">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3">手数料 <span class="text-danger">*</span></label>
                                <div class="col-lg-2">

                                    <div class="input-group">
                                        <input type="number" name="commission" class="form-control" required placeholder="50" value="{{ old('commission' , !empty($data['commission']) ? $data['commission'] : null ) }}">
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-light">円</button>
                                        </div>
                                    </div>
