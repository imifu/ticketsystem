...
<div class="page-header">
  <div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
      <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">お知らせ一覧</span></h4>
          ...
          <table class="table text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="text-default font-weight-semibold">{{ !empty($data->reco_flg) ? "有効" : ""; }}</span></td>
                  ...
                  <div class="list-icons">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('admin.newsDetail', ['id' => $data->id] ); }}" class="dropdown-item"><i class="icon-pencil5"></i> 編集</a>
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('admin.newsDelete', ['id' => $data->id] ); }}" onclick="return confirm('削除しますか？');" class="dropdown-item text-danger">
